...
/// outright for the period) to requests whose `X-Timezone` header names an
/// Indian zone — by Faraz's choice the rule is "where the person is now",
/// not their SIM or card. The device's IANA zone (`Asia/Kolkata`) is what
